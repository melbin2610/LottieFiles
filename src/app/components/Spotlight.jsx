...
const Spotlight = () => {
  return (
    <div
      className="bg-[#002b2b] p-6 sm:p-10 md:p-14 lg:p-20 xl:p-22 "
      style={{
        ...
        <div className="flex space-x-4 mt-6 justify-center karla_regular max-zr:flex-wrap ">
          {[
            ...
            },
            {
              src: react,
              alt: "React",
              href: "https://developers.lottiefiles.com/docs/dotlottie-player/dotlottie-react/",
            },
            {
              src: vue,
              alt: "Vue JS",
              href: "https://developers.lottiefiles.com/docs/dotlottie-player/dotlottie-vue/",
            },
            {
              src: svelte,
              alt: "Svelte",
              href: "https://developers.lottiefiles.com/docs/dotlottie-player/dotlottie-wc/",
            },
            {
              src: ios,
              alt: "iOS",
              href: "https://developers.lottiefiles.com/docs/dotlottie-player/dotlottie-ios/",
            },
            {
              src: android,
              alt: "Android",
              href: "https://developers.lottiefiles.com/docs/dotlottie-player/dotlottie-android/",
            },
          ].map(({ src, alt, href }) => (
            <Link
              key={alt}
