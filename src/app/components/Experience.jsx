    ...
    <div className="bg-[#101417] p-28">
      <div className='w-[90%] max-w-[1280px] mx-auto flex justify-between items-center '>
        <div className="">
          ...
          <p className="text-[24px] text-[#5e706d] font-normal">
      ...
      <div className="w-[90%] max-w-[1280px] mx-auto flex justify-between mt-24 ">
        ...
        <p className="text-[20px] text-[#5e706d] font-bold w-[87%]">Experience lightning-fast, smooth animations with our optimized high-performance runtime, designed to boost efficiency across all devices.</p>
        ...
        <p className="text-[20px] text-[#5e706d] font-bold  w-[87%]">Achieve uniform animation rendering on web, iOS, and Android, ensuring your animations perform consistently across all platforms.</p>
