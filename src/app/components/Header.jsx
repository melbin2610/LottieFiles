...
const Header = () => {
      ...
      <div className="w-[90%] max-w-[1280px] mx-auto flex items-center justify-between">
        ...
        <div className="hidden xl:flex items-center gap-5">
          <nav className="text-base text-[#20272c] flex gap-5">
            <a href="/" className="flex items-center hover:text-green-500 transition-colors duration-200">
              Products
          ...
          <div className="flex gap-5 items-center">
            ...
            <span className="text-[#019d91] text-[16px] font-bold cursor-pointer hover:text-green-200">Login</span>
  ...
  <a href="/" className="flex items-center justify-between hover:text-green-500 transition-colors duration-200 h-[100%]">
    Products
    <span className="ml-2">▼</span>
  </a>
  <a href="/" className="flex items-center justify-between hover:text-green-500 transition-colors duration-200">
    Integrations
    <span className="ml-2">▼</span>
  </a>
  <a href="/" className="flex items-center justify-between hover:text-green-500 transition-colors duration-200">
