  ...
  return (
    <div className='bg-[#101417] p-6 md:p-12'>
      <div className='w-full max-w-[1280px] mx-auto flex flex-col items-center'>
        ...
        <h3 className="text-[20px] sm:text-[20px] md:text-[28px] text-[#ffff] font-bold mt-4 text-center max-sz:text-[15px] max-sl:text-[16px]">
          In our case, this led to saving approximately 8
        </h3>
        <h3 className="text-[20px] sm:text-[20px] md:text-[28px] text-[#ffff] font-bold text-center max-sz:text-[15px] max-sl:text-[16px]">
